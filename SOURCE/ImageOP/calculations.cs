...
namespace ImageOP
{
	internal class calculations
	{
		...
		public static Dictionary<String, im> ImageLocations = new Dictionary<string, im>();
		...
		{
			ImageLocations = new Dictionary<string, im>();
			foreach (var f in Formulas)
			{
		...
		*/
		...
		private static void GetPixelIndex(int x, int y, ref int rx, ref int gx, ref int bx,im imt)
		{
			int x2;
			switch (imt.Format)
			{
		...
		private void SetPixel(int x, int y, Color newc, im to)
		{
		...
		public static Color GetPixel(int x, int y, im fromim)
		{
		...
		public static String FormulaChecks(IEnumerable<formula> flist,Dictionary<int, ICL> images)
		{
			//general checks
